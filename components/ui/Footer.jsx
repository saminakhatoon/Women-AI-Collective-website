  ...
  <div className="flex flex-col gap-16">
    ...
    <div className="flex flex-col ml-[120px] w-[256px] pt-4 pb-4 opacity-90">
      ...
      <form onSubmit={handleSubmit} className="mt-4 flex flex-col gap-4">
        <label
          htmlFor="email"
          className="text-[#FFFFFFCC] font-semibold text-[18px]"
        >
          Email Address:
        </label>
        ...
        <input
          ...
          className="text-white bg-transparent border-b outline-none"
        />

        <Button
          type="submit"
          className="border rounded-lg bg-[#FAFCFE] py-6 px-14 text-[#F1247B] font-medium"
        >
          Submit
        </Button>
      </form>
